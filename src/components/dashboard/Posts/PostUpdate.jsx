...
const PostCreate = (props) => {
    ...
    let [data, setData] = useState({
        ...
        short_des: props.data[0].short_des,
        img1:props.data[0].img1,
        img2:props.data[0].img2,
        img3:props.data[0].img3,
        img4:props.data[0].img4,
        keywords:props.data[0].keywords,
        long_des:props.data[0].long_des,
        type:props.data[0].type,
        catID:props.data[0].catID,
        tagID:props.data[0].tagID,
    ...
    const formSubmit =async (e) => {
        ...
        if(IsEmpty(data.title)){
            ...
            let res = await fetch(`/api/dashboard/post?id=${props.id}`, options);
